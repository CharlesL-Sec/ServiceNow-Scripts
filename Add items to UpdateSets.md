...
// I normally leave the below out first to identify the number of records is correct. If doing this on a large table and you get it wrong ity can take ages, and ages to delete as well....
while (gr.next()) {
